...
public class Cell extends JButton {
    ...
    public static final Color BG_NOT_REVEALED = Color.WHITE.darker();
    public static final Color FG_NOT_REVEALED = Color.RED;    // flag, mines
    public static final Color BG_REVEALED = Color.DARK_GRAY;
    public static final Color FG_REVEALED = Color.LIGHT_GRAY; // number of mines
    ...
    ImageIcon flagImage = new ImageIcon(
            "C:\\Users\\junle\\IdeaProjects\\MineSweeper\\src\\minesweeper\\flag.png");
    ImageIcon bombImage = new ImageIcon(
            "C:\\Users\\junle\\IdeaProjects\\MineSweeper\\src\\minesweeper\\bomb.png");
    ...
    public void paint() {
        ...
        if (isFlagged) {
            super.setIcon(flagImage);   // shows flag image when right-clicked
            super.setBackground(Color.WHITE);
        } else if (isRevealed && isMined) {
            super.setIcon(bombImage);   // shows bomb image when left-clicked on cell with bomb
            super.setBackground(Color.PINK);
        } else {
            super.setIcon(null);    // any other actions will remove image, eg remove flag
        }
    }
}